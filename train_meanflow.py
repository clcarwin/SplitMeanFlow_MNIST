...
def main(args):
    ...
    for epoch in range(1000000):
        ...
        for images, _ in train_dataloader:
            # x1 -> x0, x1=noises x0=images
            # xt = (1-t)x0 + t*x1
            # V(xt,t)=d_xt/d_t=x1-x0
            # x_{t-dt} = xt - V(xt,t)*dt
            # V(xt,t) = U(xt,r,t) + (t-r)*[d_U(xt,r,t)/d_t]
            ...
            equal_mask = torch.rand(batch_size, device=device) < 0.75 # 75% r==t
